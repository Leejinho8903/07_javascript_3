...
class Tiger extends Animal {
    ...
    move(lostWeight) {
        ...
        // 일반 함수를 사용하게 되면 에러 발생 -> SyntaxError: 'super' keyword unexpected here
...
// => 화살표 함수는 다른 함수의 인수로 전달 되어 콜백 함수로 사용 되는 경우가 많다. 
//    위와 같은 특징은 콜백 함수 내부의 this가 외부 함수의 this와 다르기 때문에 발생하는 문제를 해결하기 위한 의도적 설계이다.
